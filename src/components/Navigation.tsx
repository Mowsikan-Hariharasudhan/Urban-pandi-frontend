...
import { MapPin, User, Building, LogOut, Inbox, Menu, X } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <button
              onClick={toggleRole}
              className="text-xs font-medium px-2 sm:px-3 py-1 rounded-full border border-orange-200 text-orange-600 hover:bg-orange-50 transition"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 py-2 space-y-1 animate-in slide-in-from-top duration-200">
            ...
            {/* Mobile Role Toggle - Removed since it's now in header */}
