        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4 mb-6">
              <div className="relative w-14 h-14 bg-gradient-to-br from-blue-500 via-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-xl">
                <MapPin className="w-8 h-8 text-white drop-shadow-sm" />
                <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent rounded-xl"></div>
              </div>
              <div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Urban<span className="text-blue-600"> Pandi</span></h3>
                <p className="text-sm text-blue-400 font-medium">Discover Local Businesses</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start group">
                <div className="w-10 h-10 bg-blue-500/20 rounded-lg flex items-center justify-center mr-4 group-hover:bg-blue-500/30 transition-colors duration-300">
