...
"Alagar Kovil Road",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await serviceRequestAPI.createServiceRequest(dataToSend);
      ...
      toast({
        ...
        description: error.response?.data?.message || 'An error occurred while posting your request',
        variant: 'destructive'
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-24 bg-gradient-to-br from-blue-50 to-blue-50">
          <div className="container mx-auto px-4 text-center max-w-2xl">
            ...
            <p className="text-lg text-gray-600 mb-8">Posting a service request is only available in seeker mode. You're currently viewing the site as a service provider.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
              Post a <span className="text-blue-600">Service Request</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Describe your service needs and connect with local service providers.
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <Input
                      ...
                      required
                      className="hover:border-blue-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Upload an image related to your service request (optional).
                  </p>
                </div>
